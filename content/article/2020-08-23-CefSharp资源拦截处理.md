...
![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/webbrowser.png)
...
![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/src-web-page.png)
...
![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/OnBeforeBrowse.png)

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/GetResourceRequestHandler.png)
...
![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/load-without-intercept.png)

可以看到界面中呈现“test1 js file”的字样以及背景色为海蓝色。接下来我们开启资源拦截，再次加载页面，在加载过程中会有对应资源的拦截时的弹窗以及我们需要选择我们自定义的资源文件：

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/js-intercept.png)

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/js-select.png)

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/css-intercept.png)

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/css-select.png)

完成处理后，得到如下的显示页面：

![](https://res.zhen.wang/images/post/2020-08-23-cefsharp-resource-intercept/load-with-intercept.png)
