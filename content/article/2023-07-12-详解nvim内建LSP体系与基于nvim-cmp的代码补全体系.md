...
![010-ts-type-error](https://static-res.zhen.wang/images/post/2023-07-12/010-ts-type-error.png)
...
![020-lang-server-error-check-workflow](https://static-res.zhen.wang/images/post/2023-07-12/020-lang-server-error-check-workflow.png)
...
![030-nvim-lsp-arch](https://static-res.zhen.wang/images/post/2023-07-12/030-nvim-lsp-arch.png)
...
![040-nvim-lspconfig-demo-config](https://static-res.zhen.wang/images/post/2023-07-12/040-nvim-lspconfig-demo-config.png)
...
![050-nvim-lspconfig-tsserver-default-config](https://static-res.zhen.wang/images/post/2023-07-12/050-nvim-lspconfig-tsserver-default-config.png)
...
![060-ts-and-lua-ls-location](https://static-res.zhen.wang/images/post/2023-07-12/060-ts-and-lua-ls-location.png)
...
![070-ts-ls-attach-to-demo](https://static-res.zhen.wang/images/post/2023-07-12/070-ts-ls-attach-to-demo.png)
...
![080-lsp-hover-test](https://static-res.zhen.wang/images/post/2023-07-12/080-lsp-hover-test.gif)

亦或是，在错误代码的地方，调用`lua vim.lsp.buf.code_action()`，来让语言服务器给出一定的建议操作：

![090-lsp-code-action-test](https://static-res.zhen.wang/images/post/2023-07-12/090-lsp-code-action-test.gif)

当然，我们不需要每一次想要使用LSP提供的功能的时候都调用命令行方式进行，你可以在setup每一个语言服务**之前**，添加对事件`"LspAttach"`的回调，以便在打开代码文件的时候触发该回调，设置对应buffer的keymap。

![100-lsp-ts-config-format-by-keymap](https://static-res.zhen.wang/images/post/2023-07-12/100-lsp-ts-config-format-by-keymap.png)

上面的例子，我们就配置了`CTRL+ALT+l（L小写）`键来触发代码格式化（format），在我的mac机器上效果如下：

![110-lsp-ts-format-by-keymap-test](https://static-res.zhen.wang/images/post/2023-07-12/110-lsp-ts-format-by-keymap-test.gif)
...
![120-ts-lsp-native-code-action](https://static-res.zhen.wang/images/post/2023-07-12/120-ts-lsp-native-code-action.png)

但是，如果我们使用Lspsaga的code_action，就会发现一个非常舒服的UI：

![130-lsp-saga-code-action-test](https://static-res.zhen.wang/images/post/2023-07-12/130-lsp-saga-code-action-test.png)
...
![140-nvim-LSP-lspconfig-and-lspsaga](https://static-res.zhen.wang/images/post/2023-07-12/140-nvim-LSP-lspconfig-and-lspsaga.png)
...
![150-prettier-and-eslint-by-null-ls](https://static-res.zhen.wang/images/post/2023-07-12/150-prettier-and-eslint-by-null-ls.png)
...
![160-nvim-cmp-arch](https://static-res.zhen.wang/images/post/2023-07-12/160-nvim-cmp-arch.png)
...
![170-nvim-cmp-plugin-list](https://static-res.zhen.wang/images/post/2023-07-12/170-nvim-cmp-plugin-list.png)

对于nvim-cmp的setup，配置如下：

![180-nvim-cmp-config-macro](https://static-res.zhen.wang/images/post/2023-07-12/180-nvim-cmp-config-macro.png)
...
![190-nvim-cmp-source-path](https://static-res.zhen.wang/images/post/2023-07-12/190-nvim-cmp-source-path.png)
...
![200-nvim-cmp-formatting-by-lspkind](https://static-res.zhen.wang/images/post/2023-07-12/200-nvim-cmp-formatting-by-lspkind.png)
...
![210-luasnip-load-external-snippets](https://static-res.zhen.wang/images/post/2023-07-12/210-luasnip-load-external-snippets.png)
