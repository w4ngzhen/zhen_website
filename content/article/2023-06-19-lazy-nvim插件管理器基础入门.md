...
![010-simple-lazynvim-config-result](https://res.zhen.wang/images/post/2023-06-19/010-simple-lazynvim-config-result.png)
...
![020-add-plugins-by-simple-way](https://res.zhen.wang/images/post/2023-06-19/020-add-plugins-by-simple-way.png)
...
![030-setup-plugin-by-dir-arch](https://res.zhen.wang/images/post/2023-06-19/030-setup-plugin-by-dir-arch.png)

lazynvim-init.lua、plugin-lualine.lua以及plugin-nvim-tree.lua的代码具体代码如下：

![040-plugin-file-content](https://res.zhen.wang/images/post/2023-06-19/040-plugin-file-content.png)

## 安装结果验证

终于，当我们完成了插件的安装配置以后，在此启动nvim，理论上此时会看到lazy对其他插件的加载动画和加载结果：

![050-install-plugin-by-many-lua-files](https://res.zhen.wang/images/post/2023-06-19/050-install-plugin-by-many-lua-files.png)

同时，我们可以看到lualine加载后的效果：

![060-lualine-install-result](https://res.zhen.wang/images/post/2023-06-19/060-lualine-install-result.png)

命令模式下可以执行命令`:NvimTreeOpen`：

![070-nvim-tree-install-result](https://res.zhen.wang/images/post/2023-06-19/070-nvim-tree-install-result.gif)
