...
![010](https://res.zhen.wang/images/post/2025-05-28/010.png)
...
![020](https://res.zhen.wang/images/post/2025-05-28/020.png)

这个例子中最核心部分的莫过于我们在一个`loop`循环迭代中，先调用终端（terminal）实例的`draw`方法，完成对 UI 组件的绘制，紧接着读取事件做出对应按键的逻辑响应：

![030](https://res.zhen.wang/images/post/2025-05-28/030.png)
...
![040](https://res.zhen.wang/images/post/2025-05-28/040.png)
...
![050](https://res.zhen.wang/images/post/2025-05-28/050.png)
...
![060](https://res.zhen.wang/images/post/2025-05-28/060.gif)
...
![070](https://res.zhen.wang/images/post/2025-05-28/070.png)
...
![080](https://res.zhen.wang/images/post/2025-05-28/080.gif)
