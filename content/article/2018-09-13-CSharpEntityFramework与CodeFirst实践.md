...
![nugetef6](https://res.zhen.wang/images/post/2018-09-13-EF/nugetef6.png)
...
![bookdbdemo](https://res.zhen.wang/images/post/2018-09-13-EF/bookdbdemo.png)
![genguide](https://res.zhen.wang/images/post/2018-09-13-EF/genguide.png)
...
![mysqldata](https://res.zhen.wang/images/post/2018-09-13-EF/mysqldata.png)
![mysqldataentity](https://res.zhen.wang/images/post/2018-09-13-EF/mysqldataentity.png)
...
![mysqldb](https://res.zhen.wang/images/post/2018-09-13-EF/mysqldb.png)
...
![InitDb](https://res.zhen.wang/images/post/2018-09-13-EF/InitDb.png)
...
![initcomplete](https://res.zhen.wang/images/post/2018-09-13-EF/initcomplete.png)
![tabledetail](https://res.zhen.wang/images/post/2018-09-13-EF/tabledetail.png)
...
![addebookentity](https://res.zhen.wang/images/post/2018-09-13-EF/addebookentity.png)

其内容和前面大致，创建表以及回滚，这里不再展示。之后我们再次使用update-database命令将变更更新到数据库中，得到当前的数据库内容：

![afteraddtable](https://res.zhen.wang/images/post/2018-09-13-EF/afteraddtable.png)

此时我们将book表中填充一些数据：

![booktablecontent](https://res.zhen.wang/images/post/2018-09-13-EF/booktablecontent.png)

然后，我们将DbContext中的DbSet<EBook>属性删除，再次进行迁移：

![delebook](https://res.zhen.wang/images/post/2018-09-13-EF/delebook.png)

进行更新以后，我们可以看到Ebook表已经删除了，但是book表内容没有发生任何变化：

![afterdelebook](https://res.zhen.wang/images/post/2018-09-13-EF/afterdelebook.png)
...
![afteraddprop](https://res.zhen.wang/images/post/2018-09-13-EF/afteraddprop.png)

可以看到数据库中其他字段的值都没有发生变化，仅仅多出了这个字段，同时符合我们设置的可以为空的预期

![addpropdetail](https://res.zhen.wang/images/post/2018-09-13-EF/addpropdetail.png)
...
![afterdel2prop](https://res.zhen.wang/images/post/2018-09-13-EF/afterdel2prop.png)
...
```
对应数据库为
![beforerename](https://res.zhen.wang/images/post/2018-09-13-EF/beforerename.png)
...
![afterrename](https://res.zhen.wang/images/post/2018-09-13-EF/afterrename.png)
