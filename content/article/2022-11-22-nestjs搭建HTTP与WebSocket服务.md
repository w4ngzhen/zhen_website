...
![010-http-api-origin-output](https://res.zhen.wang/images/post/2022-11-22/010-http-api-origin-output.png)
...
![020-http-api-success-wrapper-output](https://res.zhen.wang/images/post/2022-11-22/020-http-api-success-wrapper-output.png)
...
![030-http-api-error-origin-output](https://res.zhen.wang/images/post/2022-11-22/030-http-api-error-origin-output.png)
...
![040-http-api-error-wrapper-output](https://res.zhen.wang/images/post/2022-11-22/040-http-api-error-wrapper-output.png)
...
![050-create-websocket](https://res.zhen.wang/images/post/2022-11-22/050-create-websocket.png)

创建后，需要注意，由于我们nestjs集成的WebSocket实现使用的socket.io，所以客户端需要匹配对应的实现（这点主要是为了匹配”请求-响应“一来一回机制）

![060-choose-socketio](https://res.zhen.wang/images/post/2022-11-22/060-choose-socketio.png)

完成配置后，我们可以采用如下的步骤进行事件发送：

![070-postman-websocket-send](https://res.zhen.wang/images/post/2022-11-22/070-postman-websocket-send.png)

发送完成后，就会看到postman的打印和nodejs服务控制台的打印，符合我们的预期：

![080-websocket-event-origin-output](https://res.zhen.wang/images/post/2022-11-22/080-websocket-event-origin-output.png)
...
![090-set-acknowledgement](https://res.zhen.wang/images/post/2022-11-22/090-set-acknowledgement.png)

完成以后，我们重新连接服务并发送数据，就可以看到一条完整的事件处理链路了：

![100-send-and-receive-origin](https://res.zhen.wang/images/post/2022-11-22/100-send-and-receive-origin.png)
...
![110-send-and-receive-success-wrapper](https://res.zhen.wang/images/post/2022-11-22/110-send-and-receive-success-wrapper.png)

## 异常过滤器

当然，我们尝试不发送任何的数据。理论上，则会进入校验流程不通过的场景，抛出BizException。在实际的发送中，我们会看到，postman无法接受到异常：

![120-send-and-receive-error-origin](https://res.zhen.wang/images/post/2022-11-22/120-send-and-receive-error-origin.png)

在服务端会看到一个异常报错：

![130-send-and-receive-error-server-output](https://res.zhen.wang/images/post/2022-11-22/130-send-and-receive-error-server-output.png)
...
![140-send-and-receive-error-wrapper](https://res.zhen.wang/images/post/2022-11-22/140-send-and-receive-error-wrapper.png)
