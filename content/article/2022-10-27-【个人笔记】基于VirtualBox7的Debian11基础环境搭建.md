...
![010-sources-list-path](https://res.zhen.blog/images/post/2022-10-27/010-sources-list-path.png)
...
![020-addition-insert-iso](https://res.zhen.blog/images/post/2022-10-27/020-addition-insert-iso.png)

使用该方式，VBox会自动查找对应的增强工具包CD镜像，并挂在到Debian系统。稍等片刻后，我们可以从桌面上看到一个名为：`VBOX_GAs_x.x.x`的CD镜像，双击打开后可以直接看到里面的内容：

![030-VBox-GAs-cd-image-content](https://res.zhen.blog/images/post/2022-10-27/030-VBox-GAs-cd-image-content.png)
...
![040-config-shared-dir](https://res.zhen.blog/images/post/2022-10-27/040-config-shared-dir.png)

![050-set-shared-dir](https://res.zhen.blog/images/post/2022-10-27/050-set-shared-dir.png)
...
![060-host-os-new-file](https://res.zhen.blog/images/post/2022-10-27/060-host-os-new-file.png)

![070-shared-file-in-linux](https://res.zhen.blog/images/post/2022-10-27/070-shared-file-in-linux.png)
