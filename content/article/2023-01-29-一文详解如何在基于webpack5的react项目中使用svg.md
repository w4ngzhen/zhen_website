...
![010-html-svg-usecase](https://res.zhen.blog/images/post/2023-01-29/010-html-svg-usecase.png)
...
![020-svg-react-component-usecase](https://res.zhen.blog/images/post/2023-01-29/020-svg-react-component-usecase.png)

效果如下：

![030-svg-react-component-display](https://res.zhen.blog/images/post/2023-01-29/030-svg-react-component-display.png)
...
![040-copy-svg-content-to-react-component](https://res.zhen.blog/images/post/2023-01-29/040-copy-svg-content-to-react-component.png)

但是每次都需要拷贝一个又一个的组件当然是一件很麻烦的事情，在webpack中我们使用svg资源的时候，其实更希望如同图片资源一样以模块的形式引入（import或者是require）并使用，就像下面一样：

![050-import-svg-component-flow](https://res.zhen.blog/images/post/2023-01-29/050-import-svg-component-flow.png)
...
![060-import-svg-without-loader](https://res.zhen.blog/images/post/2023-01-29/060-import-svg-without-loader.png)
...
![070-import-svg-by-svgr](https://res.zhen.blog/images/post/2023-01-29/070-import-svg-by-svgr.png)
...
![080-svgrwebpack-handle-flow](https://res.zhen.blog/images/post/2023-01-29/080-svgrwebpack-handle-flow.png)

## 资源模式使用

当然，我们有的时候并不想按照React组件的使用。例如，svg同样可以作为一些元素的背景，这个时候我们需要把svg是为类似于图片一样的资源，就像下面的方式：

![090-use-svg-by-url](https://res.zhen.blog/images/post/2023-01-29/090-use-svg-by-url.png)
...
![100-svg-url-result](https://res.zhen.blog/images/post/2023-01-29/100-svg-url-result.png)



这个`8ed4ed501566520a5cd0.svg`是什么呢？可能看起来还有点懵，我们尝试打包编译项目，看一下编译后的产物就知道了：

![110-build-dist-svg](https://res.zhen.blog/images/post/2023-01-29/110-build-dist-svg.png)
...
![120-code-show-svg-usecase](https://res.zhen.blog/images/post/2023-01-29/120-code-show-svg-usecase.png)
...
![130-svg-usecase-ui-display](https://res.zhen.blog/images/post/2023-01-29/130-svg-usecase-ui-display.png)

其次，从控制台也能看到对应的IconComment就是React函数组件；IconComment是svg资源的base64 DataUrl：

![140-svg-usecase-console-output](https://res.zhen.blog/images/post/2023-01-29/140-svg-usecase-console-output.png)
