...
![010-data-opr-render](https://res.zhen.blog/images/post/2023-08-31/010-data-opr-render.png)
...
![020-demo-widget-draw-rect](https://res.zhen.blog/images/post/2023-08-31/020-demo-widget-draw-rect.png)
...
![030-data-opr-render-rect-pos](https://res.zhen.blog/images/post/2023-08-31/030-data-opr-render-rect-pos.png)

然而，当我们操作时候却发现无论怎么按方向键界面似乎没有任何反应：

![040-no-update-keypress](https://res.zhen.blog/images/post/2023-08-31/040-no-update-keypress.gif)

为什么呢？让我们引入qdebug向控制台输出一些信息一探究竟：

![050-qdebug](https://res.zhen.blog/images/post/2023-08-31/050-qdebug.png)

应用运行以后，通过QDebug，我们可以在调试模式下看到控制台的输出内容：

![060-console-output-without-update](https://res.zhen.blog/images/post/2023-08-31/060-console-output-without-update.gif)
...
![070-minimize-trigger-paint](https://res.zhen.blog/images/post/2023-08-31/070-minimize-trigger-paint.gif)

当然，我们不可能为了触发绘图事件而手动操作窗体。为了达到触发绘图事件的目的，我们一般会调用控件的`update`方法系列方法或`repaint`的系列方法，来主动告诉QT需要进行控件的重新绘制，进而让QT触发`paintEvent`，绘制界面：

![080-update-for-paintEvent](https://res.zhen.blog/images/post/2023-08-31/080-update-for-paintEvent.png)

再次运行程序，并按下方向键，我们可以清楚的看到`paintEvent`在每次按下方向键以后都被调用，同时，矩形也表现出移动的效果：

![090-update-effective](https://res.zhen.blog/images/post/2023-08-31/090-update-effective.gif)
...
![100-many-update](https://res.zhen.blog/images/post/2023-08-31/100-many-update.png)

在实际调用中，只会触发一次`paintEvent`：

![110-update-many-trigger-paintEvent](https://res.zhen.blog/images/post/2023-08-31/110-update-many-trigger-paintEvent.gif)
...
![115-screen-capture](https://res.zhen.blog/images/post/2023-08-31/115-screen-capture.gif)
...
![120-make-capturing](https://res.zhen.blog/images/post/2023-08-31/120-make-capturing.gif)

想要实现这样的效果并不复杂，代码如下何解释如下：

![130-prepare-and-draw-rect](https://res.zhen.blog/images/post/2023-08-31/130-prepare-and-draw-rect.png)
...
![140-capturing-mouse-pos](https://res.zhen.blog/images/post/2023-08-31/140-capturing-mouse-pos.png)
...
![150-data-render-but-not-opr](https://res.zhen.blog/images/post/2023-08-31/150-data-render-but-not-opr.png)
...
![160-make-capturing-bug](https://res.zhen.blog/images/post/2023-08-31/160-make-capturing-bug.gif)
...
![170-capturing-mouse-pos-correct](https://res.zhen.blog/images/post/2023-08-31/170-capturing-mouse-pos-correct.png)
...
![180-capturing-rect-correct-pos](https://res.zhen.blog/images/post/2023-08-31/180-capturing-rect-correct-pos.gif)
...
![190-state-flow](https://res.zhen.blog/images/post/2023-08-31/190-state-flow.png)
...
![200-explore-capturing-captured](https://res.zhen.blog/images/post/2023-08-31/200-explore-capturing-captured.gif)
...
![210-get-screen-qimage-and-init](https://res.zhen.blog/images/post/2023-08-31/210-get-screen-qimage-and-init.png)
...
![220-screen-qimage-paint](https://res.zhen.blog/images/post/2023-08-31/220-screen-qimage-paint.png)

于是，界面运行以后，我们就能看屏幕截图填充在窗口里面的效果：

![230-capture-screen](https://res.zhen.blog/images/post/2023-08-31/230-capture-screen.gif)
...
![240-wrong-rect](https://res.zhen.blog/images/post/2023-08-31/240-wrong-rect.gif)
...
![250-capturedRect-scale-convert](https://res.zhen.blog/images/post/2023-08-31/250-capturedRect-scale-convert.png) 
...
![260-after-scale-convert-rect](https://res.zhen.blog/images/post/2023-08-31/260-after-scale-convert-rect.gif)
