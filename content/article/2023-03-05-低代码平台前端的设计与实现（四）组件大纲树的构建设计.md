...
![010-effect](https://res.zhen.wang/images/post/2023-03-05/010-effect.gif)
...
![020-DesignCanvasOldVersion](https://res.zhen.wang/images/post/2023-03-05/020-DesignCanvasOldVersion.png)
...
![030-DesignCanvasWithNodeTreeIdea](https://res.zhen.wang/images/post/2023-03-05/030-DesignCanvasWithNodeTreeIdea.png)
...
![040-selectedNodePathChangeEvent](https://res.zhen.wang/images/post/2023-03-05/040-selectedNodePathChangeEvent.png)
...
![selectedKeys](https://res.zhen.wang/images/post/2023-03-05/050-selectedKeys.gif)
...
![060-selectedKeys-workflow](https://res.zhen.wang/images/post/2023-03-05/060-selectedKeys-workflow.png)
...
![070-selectedKeys-with-control](https://res.zhen.wang/images/post/2023-03-05/070-selectedKeys-with-control.gif)
...
![080-expandedKeys-without-control](https://res.zhen.wang/images/post/2023-03-05/080-expandedKeys-without-control.gif)

可以看到，无论怎样点击节点左侧的三角，都无法展开或收起对应的子节点。类似的，我们使用一个state来存储展开的节点，然后使用onExpand事件来设置，即可达到效果：

![090-expandedKeys-with-control.gif](https://res.zhen.wang/images/post/2023-03-05/090-expandedKeys-with-control.gif)
...
![100-ComponentNodeTreeDesignPanel-workflow](https://res.zhen.wang/images/post/2023-03-05/100-ComponentNodeTreeDesignPanel-workflow.png)
...
![110-final-real-effect](https://res.zhen.wang/images/post/2023-03-05/110-final-real-effect.gif)
