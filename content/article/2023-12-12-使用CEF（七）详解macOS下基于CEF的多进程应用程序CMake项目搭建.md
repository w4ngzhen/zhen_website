...
![010-cef-exe-excute-flow](https://res.zhen.wang/images/post/2023-12-12/010-cef-exe-excute-flow.png)
...
![020-copy-FindCEF](https://res.zhen.wang/images/post/2023-12-12/020-copy-FindCEF.png)
...
![030-libcef_dll_wrapper_var_path](https://res.zhen.wang/images/post/2023-12-12/030-libcef_dll_wrapper_var_path.png)
...
![040-pin-add_subdir_param](https://res.zhen.wang/images/post/2023-12-12/040-pin-add_subdir_param.png)

这里需要这个参数值的原因在于，`libcef_dll_wrapper`所在目录是一个**外部路径**，所以需要提供一个**目录名**作为的CMake文件二进制生成的路径。如果不提供，则会收到错误：

![050-add_subdir_no-param-error](https://res.zhen.wang/images/post/2023-12-12/050-add_subdir_no-param-error.png)
...
![060-cmake-bin-dir-generate.png](https://res.zhen.wang/images/post/2023-12-12/060-cmake-bin-dir-generate.png)
...
![070-build-dll-wrapper](https://res.zhen.wang/images/post/2023-12-12/070-build-dll-wrapper.png)

如果一切没有问题的情况下，我们可以在output目录中找到`libcef_dll_wrapper`的生成出来的库文件：

![080-libcef_dll_wrapper-build-ok](https://res.zhen.wang/images/post/2023-12-12/080-libcef_dll_wrapper-build-ok.png)
...
![090-MACOS_BUNDLE-param-diff](https://res.zhen.wang/images/post/2023-12-12/090-MACOS_BUNDLE-param-diff.png)
...
![100-copy-CEF-framework](https://res.zhen.wang/images/post/2023-12-12/100-copy-CEF-framework.png)

在上面的讲解中我们大致理解了macOS的App Bundle的应用程序组织结构，细心的读者会发现，在构建后的Bundle中的根目录下有一个文件`Info.plist`：

![110-info-plist-file](https://res.zhen.wang/images/post/2023-12-12/110-info-plist-file.png)
...
![120-info-plist-content](https://res.zhen.wang/images/post/2023-12-12/120-info-plist-content.png)
...
![130-sub-process-new-file](https://res.zhen.wang/images/post/2023-12-12/130-sub-process-new-file.png)
...
![140-build-result](https://res.zhen.wang/images/post/2023-12-12/140-build-result.png)
