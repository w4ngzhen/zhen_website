...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/010-show-js-alert.gif)

同样，当我们使用`confirm('ok?')`的时候，会显示如下：

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/020-show-js-confirm.gif)

以及，使用`prompt(input your name: ')`，有如下的显示：

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/030-show-js-prompt.gif)
...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/040-show-js-alert-in-jcef.gif)

**confirm**

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/050-show-js-confirm-in-jcef.gif)

**prompt**

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/060-show-js-prompt-in-jcef.gif)
...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/070-onJSDialog-thread.jpg)

而EventQueue.invokeLater中所运行的线程是：`AWT-EventQueue-0`，这个线程就是IDEA插件中的GUI线程。

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/080-EventQueueInvokeLater-thread.jpg)

修改线程处理后，让我们再次调用alert：

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/090-new-not-perfect-alert-dialog.gif)
...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/100-ok-action-in-alert.jpg)

重新运行，查看AlertDialog的效果：

![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/110-new-perfect-alert-dialog.gif)
...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/120-new-confirm-dialog.gif)
...
![](https://res.zhen.blog/images/post/2021-10-06-intelliJ-plugin-dev-2/130-new-prompt-dialog.gif)
