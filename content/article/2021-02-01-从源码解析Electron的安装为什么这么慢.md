...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/electron-postinstall.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/electron-pkgjson.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/download-electron-code.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/where-is-downloadArtifact.jpg)

该函数的文档：下载Electron发行制品，并且返回下载后的制品的绝对路径。而函数内部主要流程如下：

![](https://res.zhen.wang/images/post/2021-02-01-install-electron/func-flow.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/getArtifactRemoteURL.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/just-env.jpg)

但是一旦通过npm进行运行，又会不一样：

![](https://res.zhen.wang/images/post/2021-02-01-install-electron/run-with-npm.jpg)

运行命令`npm run dev`，会得到如下的结果，这里本人使用IDEA的断掉调试，会更加清晰的看到env的值：

![](https://res.zhen.wang/images/post/2021-02-01-install-electron/npm-env.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/proc-env-ignore-case.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/get-cache-path.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/getCachePath.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/default-cache-root-def.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/cache-file-list.jpg)
...
![](https://res.zhen.wang/images/post/2021-02-01-install-electron/url-resolve.jpg)
