...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/libcef-lib-list.jpg)

- 你需要使用libcef_dll_wrapper静态库文件，它来自于你编译出来的静态库：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/libcef-dll-lib-list.jpg)

- 你需要libcef与wrapper的include文件，它来自于：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/include-files.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/files-dir.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/create-sln.jpg)

创建一个名为simple-cef的项目

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/create-proj.jpg)

创建完成后，我们删除所有模板生成的代码，得到一个完全空白的应用程序项目：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/delete-all-files.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/20210122161019.png)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/additional-include-dir.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/20210122162053.png)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/add-the-additional-dependencies.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/same-config.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/files-arch.jpg)

我们右键项目使用build指令进行尝试编译，如果不出意外会看到这些内容：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/compile-error.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/proj-runtime-lib.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/wrapper-runtime-lib.jpg)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/cef-resources.jpg)

把**Resources**文件夹里面的所有文件和子文件夹复制到运行目录下。

- CEF依赖库文件

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/cef-runtime-dep-lib.jpg)

将上图中**除了两个lib库文件之外**的组件拷贝到运行目录下。

此时，我们的编译出来的运行目录如下：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/app-files-list.png)

我们再次尝试运行该simple-cef，终于能够成功打开，然而**再次**不出意外的话，会看到一个白屏的浏览器窗口。**首先会看到标题，然后转为对应的空白**：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/title-change-and-white-screen.gif)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/debug-log-error.png)
...
![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/add-my-manifest.png)

保存后，我们再次构建项目并运行我们的simple-cef.exe，终于看到了期待已久的页面：

![](https://res.zhen.wang/images/post/2021-01-15-write-simple-cef/simple-cef-demo-show.gif)
